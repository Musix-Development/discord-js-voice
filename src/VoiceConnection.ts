...
import { GatewayVoiceServerUpdateDispatchData, GatewayVoiceStateUpdateData } from 'discord-api-types/v8';
...
export class VoiceConnection extends EventEmitter {
	...
	private readonly packets: {
		...
		state: GatewayVoiceStateUpdateData|undefined;
	};
	 ...
	 */
	public addStatePacket(packet: GatewayVoiceStateUpdateData) {
