import { GatewayOPCodes, GatewayVoiceServerUpdateDispatchData, GatewayVoiceStateUpdateData } from 'discord-api-types/v8';
...
export function trackClient(client: Client) {
	...
	client.ws.on('VOICE_STATE_UPDATE', (payload: GatewayVoiceStateUpdateData) => {
